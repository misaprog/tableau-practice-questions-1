...
［列］	［カウント（1.10_whiskey.csv）］  
［行］	［Bottle name］  
［マーク］カードの［色］	［Sentiment］  
［フィルター］	　［Brand］※［単一値（リスト）］でフィルターを表示 (右側の▼から）
その他	降順で並べ替え済  

1. 表を参考に棒グラフを作成します。  
2. ［データ］ペインから［ID］を［マーク］カードの［詳細］にドロップします。棒を ID で分けることで、各 ID が積み重なって 1 つの棒グラフを構成するようにします。  
3. ツールヒントにレビュー内容を表示します。［データ］ペインから［Title］、［Review Content］を［マーク］カードの［ツールヒント］にドロップします。  
4. ［マーク］カードの［ツールヒント］をクリックします。  
5. 図を参考に、ツールヒントを整えます。
   
<img width="479" height="363" alt="スクリーンショット 2026-01-21 134646" src="https://github.com/user-attachments/assets/88b7d569-da24-4fea-b2a0-d0e19152157a" />

6. ［OK］をクリックして画面を閉じます。  
7. ［マーク］カードの［色］をクリックして、色を変更します。［枠線］を［自動］から指定の色に変更することで、ID ごとに分割されていることが分かりやすくなります。  
8. 画面右上のフィルターで［Hibiki］を選択します。

<img width="1321" height="732" alt="スクリーンショット 2026-01-21 134008" src="https://github.com/user-attachments/assets/aaa36840-686b-4314-a1ce-0b4b205a0d6a" />
